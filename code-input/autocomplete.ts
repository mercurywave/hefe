import { CodeInput, Plugin } from "./code-input.js";
...
export class Autocomplete extends Plugin {
    observedAttributes = [];
    public updatePopupCallback: (popupElem: HTMLElement, textarea: HTMLTextAreaElement, selectionEnd: number) => void;
    /**
    ...
    updatePopup(codeInput: CodeInput, onlyScrolled: boolean) {
    ...
    afterElementsAdded(codeInput: CodeInput) {
