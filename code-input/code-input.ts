...
export class CodeInput extends HTMLElement{
    ...
    public static usedTemplates: Record<string,Template> = {};
    public static templateQueue: Record<string,CodeInput[]> = {};
    ...
    public set placeholder(val) {
        this.setAttribute("placeholder", val);
    }

    public set selectionStart(val: number) {this.querySelector("textarea").selectionStart = val;}
...
export class Plugin {
    ...
    public beforeHighlight(codeInput) {}
    /* Runs after code is highlighted; Params: codeInput element) */
    public afterHighlight(codeInput) {}
    /* Runs before elements are added into a `code-input`; Params: codeInput element) */
    public beforeElementsAdded(codeInput) {}
    /* Runs after elements are added into a `code-input` (useful for adding events to the textarea); Params: codeInput element) */
    public afterElementsAdded(codeInput) {}
    ...
    public attributeChanged(codeInput, name, oldValue, newValue) {}
}
...
export class Template{
    ...
    public constructor(preElementStyled=true, isCode=true, includeCodeInputInHighlightFunc=false, plugins=[]){
    ...
    public highlight(result_element: Element, code_input?: CodeInput){

    }
}

export class CustomTemplate extends Template{
    _highlight: (result_element: Element, code_input?: CodeInput) => void;
    public constructor(highlight=function() {}, preElementStyled=true, isCode=true, includeCodeInputInHighlightFunc=false, plugins=[]){
...
export class RainbowText extends Template{
    ...
    delimiter: string;
    public constructor(rainbow_colors=["red", "orangered", "orange", "goldenrod", "gold", "green", "darkgreen", "navy", "blue",  "magenta"], delimiter="", plugins=[])
    {
